...
def main():
    ...
    st.sidebar.markdown("## Análise de Performance de Campanhas")
    
    page = st.sidebar.radio("Ir para:", ["Campanhas (Por Loja)", "Visão Financeira (Por Loja)", "Visão Geral (Todas as Lojas)", "Testes de cálculos"])
    if page == "Campanhas (Por Loja)":
    ...
    elif page == "Visão Financeira (Por Loja)":
    ...
    elif page == "Visão Geral (Todas as Lojas)":
